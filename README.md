...
The reason is we assume the stable molecular structure requires ca 120 degree AC-N-AC bond angle. Then the smallest combination to form a marco-ring is 2C+2L.
